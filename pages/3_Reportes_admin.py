...
from utils_admin import admin_get_student_group_emails, admin_get_attendance_dates, admin_load_students, admin_get_last_updated, admin_delete_attendance_dates, admin_save_attendance
...
try:
    ...
    attendance_last_updated = admin_get_last_updated('attendance', selected_course)
    all_attendance = admin_get_attendance_dates(selected_course , attendance_last_updated)
    if all_attendance:
...
if start_date > end_date:
    ...
    if st.button("Generar Reporte", key="generate_report_btn", type="primary"): # Translated
        ...
        all_students_df, _ = admin_load_students(selected_course, students_last_updated)
